...
import Me from '../../../public/assets/avatarPhoto2.png'
      ...
      <div id='about' className='w-full md:h-screen p-2 flex items-center py-16 justify-center' >
       ...
       <TextTitle title={about}/>
        <div className='flex gap-20 flex-col md:flex-row items-center md:items-start'>
          <div className=' relative duration-500 group bg-white  w-[400px] h-[400px] shadow-2xl rounded-3xl'>
              <Image src={Me} className='object-cover h-full w-full' alt='profile'/>
              <div className='w-full h-full border-2 rounded-3xl border-amber-300 absolute -z-10 top-5 left-5 md:group-hover:top-10 md:group-hover:left-10 duration-500'/>
          </div>
