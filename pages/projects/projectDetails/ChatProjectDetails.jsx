...
const ChatProjectDetails = () => {
    ...
    const imageData = chatProjectImageData.map(el => ( 
    ...
    const featurePointData = chatProjectFeaturesData.map(el => <FeaturePoint title={el.title[lang]} descr={el.descr[lang]}/>)
  return (
    <div className='flex justify-between mt-24 w-[90%] h-[80%] mb-20'>
        <div className='w-[40%] h-full flex flex-col gap-10'>
        <h2 className='bg-clip-text text-transparent bg-gradient-to-r from-amber-300 via-amber-100 to-slate-200 w-fit text-5xl'>Bubble Chat</h2>
        ...
        <p className='text-slate-800 text-left'>{chatProjectSubDescr[lang]}</p>
        ...
        <div className='flex flex-col gap-5'>
            ...
            <div className='w-8 h-full ml-16'>
                <Image src={axios} className='object-cover w-auto h-full'/>
            </div>
            <p>Axios</p>
            </div>
        </div>
        <div className='flex flex-col gap-5'>
            ...
            <div className='flex items-center font-semibold gap-3 mt-2'>
                <div className='w-10 h-full ml-16'>
                    <Image src={socket} className='object-cover w-auto h-full'/>
                </div>
                <p>Socket.io</p>
            </div>
        </div>
...
export default ChatProjectDetails